...
${OBJECTDIR}/modules/box_collision.o: modules/box_collision.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/box_collision.o modules/box_collision.c

${OBJECTDIR}/modules/bullets.o: modules/bullets.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/bullets.o modules/bullets.c

${OBJECTDIR}/modules/display.o: modules/display.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/display.o modules/display.c

${OBJECTDIR}/modules/enemies.o: modules/enemies.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/enemies.o modules/enemies.c

${OBJECTDIR}/modules/enemy_bullets.o: modules/enemy_bullets.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/enemy_bullets.o modules/enemy_bullets.c

${OBJECTDIR}/modules/explosion_bullets.o: modules/explosion_bullets.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/explosion_bullets.o modules/explosion_bullets.c

${OBJECTDIR}/modules/gravity_bullets.o: modules/gravity_bullets.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/gravity_bullets.o modules/gravity_bullets.c

${OBJECTDIR}/modules/player.o: modules/player.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/player.o modules/player.c
...
${TESTDIR}/tests/collision_test.o: tests/collision_test.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/collision_test.o tests/collision_test.c
...
${OBJECTDIR}/modules/box_collision_nomain.o: ${OBJECTDIR}/modules/box_collision.o modules/box_collision.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/box_collision_nomain.o modules/box_collision.c;\
	else  \
...
${OBJECTDIR}/modules/bullets_nomain.o: ${OBJECTDIR}/modules/bullets.o modules/bullets.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/bullets_nomain.o modules/bullets.c;\
	else  \
	    ${CP} ${OBJECTDIR}/modules/bullets.o ${OBJECTDIR}/modules/bullets_nomain.o;\
	fi

${OBJECTDIR}/modules/display_nomain.o: ${OBJECTDIR}/modules/display.o modules/display.c 
	${MKDIR} -p ${OBJECTDIR}/modules
	@NMOUTPUT=`${NM} ${OBJECTDIR}/modules/display.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/display_nomain.o modules/display.c;\
	else  \
	    ${CP} ${OBJECTDIR}/modules/display.o ${OBJECTDIR}/modules/display_nomain.o;\
	fi
...
${OBJECTDIR}/modules/enemies_nomain.o: ${OBJECTDIR}/modules/enemies.o modules/enemies.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/enemies_nomain.o modules/enemies.c;\
	else  \
...
${OBJECTDIR}/modules/enemy_bullets_nomain.o: ${OBJECTDIR}/modules/enemy_bullets.o modules/enemy_bullets.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/enemy_bullets_nomain.o modules/enemy_bullets.c;\
	else  \
...
${OBJECTDIR}/modules/explosion_bullets_nomain.o: ${OBJECTDIR}/modules/explosion_bullets.o modules/explosion_bullets.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/explosion_bullets_nomain.o modules/explosion_bullets.c;\
	else  \
...
${OBJECTDIR}/modules/gravity_bullets_nomain.o: ${OBJECTDIR}/modules/gravity_bullets.o modules/gravity_bullets.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/gravity_bullets_nomain.o modules/gravity_bullets.c;\
	else  \
...
${OBJECTDIR}/modules/player_nomain.o: ${OBJECTDIR}/modules/player.o modules/player.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/modules/player_nomain.o modules/player.c;\
	else  \
